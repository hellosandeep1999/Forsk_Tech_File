...
Society Field Guide to North American Mushrooms (1981). Each species is identified as 
...
Health (Add Health) data set, an ongoing (longitudinal) survey study that began 
in the mid-1990s is used. The project website URL is:
